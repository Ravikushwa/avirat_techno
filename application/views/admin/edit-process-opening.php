                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Add Process Master</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Add Process Master</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card-box">
                                ...
                                <form action="<?= base_url('process-opening'); ?>" id="workorder_edit" method="POST" enctype="multipart/form-data" data-parsley-validate novalidate >
                                ...
                                <div class="row">
                                        <div class="col-md-9">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                   <input class="form-control" type="text" name="challen_no" id="challen_no"  value="<?= $process_opening['id'] ?>" readonly > 
                                                   <input type="hidden" class="form-control" id="title_id" name="title_id" value="<?= $process_opening['id'] ?>" >
                                                </div>
                                                 <label class="col-md-2 control-label">Date</label>
                                                <div class="col-md-4">
                                                   <input class="form-control" type="date" name="date" id="date" parsley-trigger="change" required  value="<?= $process_opening['date'] ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-md-2 control-label">Remark</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" name="remark" id="remark" parsley-trigger="change" required  value="<?= $process_opening['remark'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div id="dataAdd">
                                        ...
                                        <?php
                                            $item_name = json_decode( $process_opening['item_name'] );
                                            $bundle_no = json_decode( $process_opening['bundle_no'] );
                                            $process = json_decode( $process_opening['process'] );
                                            $final_item_code = json_decode( $process_opening['final_item_code'] );
                                            $pcs = json_decode( $process_opening['pcs'] );
                                            $qty = json_decode( $process_opening['qty'] );
                                        ...
                                        <div class="row total_row">
                                            ...
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    <input class="form-control total_pcs" type="number" name="total_pcs" value="<?= $process_opening['total_pcs'] ?>" step="0.01" placeholder="0.00" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    <input class="form-control total_qty" type="number" name="total_qty" value="<?= $process_opening['total_qty'] ?>" step="0.01" placeholder="0.00" readonly>
                                                </div>
                                            </div>
                                        </div>
