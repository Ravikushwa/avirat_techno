            ...
            <div class="content">
                ...
                <div class="container-fluid">
                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Jobwork Inward</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Jobwork Inward</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card-box">
                                <h4 class="header-title mb-4">Jobwork Inward </h4>
                                <div class="right_btn float-right">
                                    <a href="<?= base_url('Admin/add_jobwork_inward') ?>" class="float-rightbtn btn-dark waves-effect width-md waves-light" style="text-align:center;">Add New</a>
                                </div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                        <?php  
                                        if( !empty($jobwork_inward)){
                                        $i = 1;
                                        foreach ($jobwork_inward as $key => $value) { 
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= base_url('Admin/edit_jobwork_inward')."?id=".$value['id'] ?>"
                                                     class="tabledit-edit-button btn btn-primary" style="float: none;"><span class="mdi mdi-pencil"></span></a> &nbsp;
                                                    <a href="<?= base_url('Admin/deleteData?').'table=jobwork_inward&id='.$value['id']; ?>" class="tabledit-delete-button btn btn-danger" onclick="return confirm('Are you sure you want to delete')" style="float: none;"><span class="mdi mdi-delete-alert"></span></a>
                                                </td>
                                            </tr>
                                        <?php $i++; }} ?>
