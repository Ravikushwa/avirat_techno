            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card-box">
                                <h4 class="header-title mb-4">BOM Master</h4>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        if( !empty($bom_master)){
                                        $i = 1;
                                        foreach ($bom_master as $key => $value) { 
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?= base_url('Admin/deleteData?').'table=bom_master&id='.$value['id']; ?>" class="tabledit-delete-button btn btn-danger" onclick="return confirm('Are you sure you want to delete')" style="float: none;"><span class="mdi mdi-delete-alert"></span></a>
                                                </td>
                                            </tr>
                                        <?php $i++; }} ?>
