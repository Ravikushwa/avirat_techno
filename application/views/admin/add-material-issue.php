                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card-box">
                                ...
                                <form action="<?= base_url('material-issue'); ?>" id="item-group_add" method="POST" enctype="multipart/form-data" data-parsley-validate novalidate >   
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="form-group row">
                                             ...
                                             <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                   <input class="form-control" type="text" name="wo_no" id="wo_no"  value="" > 
                                                </div>
                                                 <label class="col-md-2 control-label">WO Date</label>
                                                <div class="col-md-4">
                                                   <input class="form-control" type="date" name="wo_date" id="wo_date" parsley-trigger="change" required  value="">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-md-2 control-label">Issue By</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" name="issue_by" id="issue_by" parsley-trigger="change" required  value="">
                                                </div>
                                            </div>
                                            <div class="form-group row">
