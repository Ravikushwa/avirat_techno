                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card-box">
                                ...
                                <form action="<?= base_url('workorder'); ?>" id="workorder_edit" method="POST" enctype="multipart/form-data" data-parsley-validate novalidate >
                                    ...
                                    <div class="row">
                                        <div class="col-md-9">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                   <input class="form-control" type="date" name="date" id="date" parsley-trigger="change" required  value="<?= $workorder['date'] ?>">
                                                   <input type="hidden" class="form-control" id="title_id" name="title_id" value="<?= $workorder['id'] ?>" >
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                   <select class="form-control " name="item" id="item" parsley-trigger="change" required="">
                                                        ...
                                                        ?>
                                                           <option value="<?= $value['id'] ?>" <?= ($workorder['item'] == $value['id'] )?"selected":""; ?> ><?= $value['ledger'] ?></option>
                                                        <?php } } ?>
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-10">
                                                   <select class="form-control " name="process" id="process" parsley-trigger="change" required="">
                                                        <?php if( !empty($process_master)){ 
                                                           foreach ($process_master as $key => $value) {  
                                                        ?>
                                                           <option value="<?= $value['id'] ?>" <?= ($workorder['process'] == $value['id'] )?"selected":""; ?> ><?= $value['process_name'] ?></option>
                                                        <?php } } ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                   <input class="form-control" type="date" name="valid_from" id="valid_from" parsley-trigger="change" required  value="<?= $workorder['valid_from'] ?>">
                                                </div>
                                                <label class="col-md-2 control-label">Valid To</label>
                                                <div class="col-md-4">
                                                    <input class="form-control" type="date" name="valid_to" id="valid_to" parsley-trigger="change" required  value="<?= $workorder['valid_to'] ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-md-2 control-label">Remark</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" name="remark" id="remark" parsley-trigger="change" required  value="<?= $workorder['remark'] ?>">
                                                </div>
                                            </div>
                                        </div>
...
<div class="col-md-4">
                                        ...
                                        <?php
                                            $item_name = json_decode( $workorder['item_name'] );
                                            $process = json_decode( $workorder['process1'] );
                                            $rate = json_decode( $workorder['rate'] );
                                        ...
                                        <div class="row total_row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <input class="form-control total_rate" type="number" name="total_rate" value="<?= $workorder['total_rate'] ?>" step="0.01" placeholder="0.00" readonly>
                                                </div>
                                            </div>
                                        </div>
