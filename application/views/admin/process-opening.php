            ...
            <div class="content">
                ...
                <div class="container-fluid">
                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Process Opening </li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Process Opening</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card-box">
                                <h4 class="header-title mb-4">Process Opening</h4>
                                <div class="right_btn float-right">
                                    <a href="<?= base_url('Admin/add_process_opening') ?>" class="float-rightbtn btn-dark waves-effect width-md waves-light" style="text-align:center;">Add New</a>
                                </div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                        <?php  
                                        if( !empty($process_opening)){
                                        $i = 1;
                                        foreach ($process_opening as $key => $value) { 
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $value['remark'] ?></td>
                                                <td>
                                                    <a href="<?= base_url('Admin/edit_process_opening')."?id=".$value['id'] ?>"
                                                     class="tabledit-edit-button btn btn-primary" style="float: none;"><span class="mdi mdi-pencil"></span></a> &nbsp;
                                                    <a href="<?= base_url('Admin/deleteData?').'table=process_opening&id='.$value['id']; ?>" class="tabledit-delete-button btn btn-danger" onclick="return confirm('Are you sure you want to delete')" style="float: none;"><span class="mdi mdi-delete-alert"></span></a> 
                                                </td>
                                            </tr>
                                        <?php $i++; }} ?>
