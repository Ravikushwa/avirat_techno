...
<head>
    <meta charset="utf-8" />
    <title>vendors | Zircos - Responsive Bootstrap 4 Admin Dashboard</title>
        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <a href="#custom-modal" class="btn btn-primary waves-effect waves-light mb-3" data-animation="fadein" data-plugin="custommodal" data-overlaySpeed="200" data-overlayColor="#36404a"><i class="md md-add"></i> Add Vendor</a>
                        </div>
                        <!-- end col -->
                        <div class="col-sm-8">
                        ...
                        <div class="col-lg-4">
                            <div class="text-center card-box">
                                ...
                                <div class="member-card">
                                    ...
                                    <div class="mt-3">
                                        <h4 class="font-18 mb-1">Mark McKnight</h4>
                                    ...
                                    <button type="button" class="btn btn-primary mt-3 btn-rounded btn-bordered waves-effect width-md waves-light">Send Message</button>
                        ...
                        <div class="col-lg-4">
                            <div class="text-center card-box">
                                ...
                                <div class="member-card">
                                    ...
                                    <div class="mt-3">
                                        <h4 class="font-18 mb-1">David Flores</h4>
                                        <p class="text-muted">@webdesigner <span> | </span> <span> <a href="#" class="text-pink">websitename.com</a> </span></p>
                                    </div>
                        ...
                        <div class="col-lg-4">
                            <div class="text-center card-box">
                                ...
                                <div class="member-card">
                                    ...
                                    <div class="mt-3">
                                        <h4 class="font-18 mb-1">Javier Bell</h4>
                                        <p class="text-muted">@webdesigner <span> | </span> <span> <a href="#" class="text-pink">websitename.com</a> </span></p>
                                    </div>
                        ...
                        <div class="col-lg-4">
                            <div class="text-center card-box">
                                ...
                                <div class="member-card">
                                    ...
                                    <div class="mt-3">
                                        <h4 class="font-18 mb-1">Kyle Stennett</h4>
                                        <p class="text-muted">@webdesigner <span> | </span> <span> <a href="#" class="text-pink">websitename.com</a> </span></p>
                                    </div>
                        ...
                        <div class="col-lg-4">
                            <div class="text-center card-box">
                                ...
                                <div class="member-card">
                                    ...
                                    <div class="mt-3">
                                        <h4 class="font-18 mb-1">Jorge Gaines</h4>
                                        <p class="text-muted">@webdesigner <span> | </span> <span> <a href="#" class="text-pink">websitename.com</a> </span></p>
                                    </div>
                        ...
                        <div class="col-lg-4">
                            <div class="text-center card-box">
                                ...
                                <div class="member-card">
                                    ...
                                    <div class="mt-3">
                                        <h4 class="font-18 mb-1">Brian Smith</h4>
                                        <p class="text-muted">@webdesigner <span> | </span> <span> <a href="#" class="text-pink">websitename.com</a> </span></p>
                                    </div>
    ...
    <div id="custom-modal" class="modal-demo">
        ...
        <div class="custom-modal-text text-left">
            <form>
                ...
                <button type="button" class="btn btn-danger waves-effect waves-light ml-2">Cancel</button>
            </form>
        </div>
    </div>
